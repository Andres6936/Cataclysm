...
std::string pathing_feature_name(Pathing_feature feat)
{
	...
	case PATHFEAT_NULL:
		return "NULL";
	case PATHFEAT_FIELDS:
		return "fields";
	case PATHFEAT_MAX:
		return "BUG - PATHFEAT_MAX";
	default:
		return "BUG - Unnamed Pathing_feature";
	}
...
std::string AI_goal_name(AI_goal goal)
{
	...
	case AIGOAL_FLEE:
		return "flee";
	case AIGOAL_EAT_CORPSES:
		return "eat_corpses";
	case AIGOAL_COLLECT_ITEMS:
		return "collect_items";
	case AIGOAL_MAX:
		return "BUG - AIGOAL_MAX";
	default:
		return "BUG - Unnamed AI_goal";
	}
