...
std::string interface_action_name(Interface_action action)
{
	...
	case IACTION_ADVANCE_FIRE_MODE:
		return "advance_fire_mode";
	case IACTION_EAT:
		return "eat";
	case IACTION_MESSAGES_SCROLL_BACK:
		return "messages_scroll_back";
	case IACTION_MESSAGES_SCROLL_FORWARD:
		return "messages_scroll_forward";
	case IACTION_VIEW_WORLDMAP:
		return "view_worldmap";
	...
	case IACTION_DEBUG:
		return "debug";
	case IACTION_MAX:
		return "BUG - IACTION_MAX";
	default:
		return "BUG - Unnamed action";
	}
...
std::string debug_action_name(Debug_action action)
{
	...
	case DEBUG_ACTION_GAIN_XP:
		return "gain_xp";
	case DEBUG_ACTION_MAX:
		return "BUG - DEBUG_ACTION_MAX";
	default:
		return "BUG - Unnamed Debug_action";
	}
