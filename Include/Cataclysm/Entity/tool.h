...
#include "Cataclysm/Entity/skill.h"  // Some actions are affected by skill
#include <string>
#include <istream>
...
struct Tool_special
{
	...
	virtual Tool_special_type get_type()
	{
		return TOOL_SPECIAL_NULL;
	}
